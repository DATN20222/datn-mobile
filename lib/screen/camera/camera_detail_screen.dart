                      ...
                      if (controller.usersInRoom.isNotEmpty) ...[
                        Padding(
                          ...
                          child: Text("Users",
                              style: GoogleFonts.play(
                                  textStyle: const TextStyle(
                                      color: Color(0xFF6759ED), fontSize: 18)),
                        ...
                        //   height: 180,
                          ...
                          //   shrinkWrap: true,
                          //   children:
                           ...controller.usersInRoom
                                .map((element) => ListTile(
                                    title: Text("User: ${element.name}",
                                        style: GoogleFonts.play()),
                                    subtitle: Text(
                                        "Thời gian: ${DateFormat().format(DateTime.fromMillisecondsSinceEpoch(element.history[element.history.length - 1].timeStamp.millisecondsSinceEpoch))}")))
                                .toList(),
                        // ),
                          //
                          //                               ),
